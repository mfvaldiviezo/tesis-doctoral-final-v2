...
# else:
#     sys.exit("Please set SUMO_HOME \n ie. export SUMO_HOME=/home/jault/venv/resco/lib/python3.10/site-packages/sumo")
...
# TODO needs major improvements + rerelease EPyMARL adjustment
...
# log_dir = '/home/jault/projects/resco_fresh/results'
#
# maps = ['grid1x1', 'grid1x2', 'grid4x4', 'arterial4x4', 'cologne1', 'cologne3', 'cologne8', 'ingolstadt1', 'ingolstadt7', 'ingolstadt21']
